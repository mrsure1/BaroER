        ...
        <div className="relative flex h-full min-h-0 flex-col gap-2 p-3 sm:p-3.5">
          ...
          */}
          <Link
            ...
            className={cn(
              "hero-start-cta flex min-h-[88px] w-full shrink-0 items-center justify-center gap-2.5 rounded-2xl bg-black/25 px-3 py-5 text-[18px] font-extrabold text-white backdrop-blur-sm transition-[background-color] hover:bg-black/35 sm:min-h-[96px] sm:text-[19px]",
            )}
          >
            시작하기
